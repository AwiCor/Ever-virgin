...
(function () {
  ...
  async function startPrayerPage() {
    ...
    let steps = buildSteps(prayerSetFor(lang), mysterySet, sessionPicks, saintPrayer, saintBio, mysteryKey);
    function rebuildSteps() {
      steps = buildSteps(prayerSetFor(lang), mysterySet, sessionPicks, saintPrayer, saintBio, mysteryKey);
    }
